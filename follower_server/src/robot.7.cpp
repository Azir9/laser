...
max_cluster_dis(0.04),min_cluster_num(5),cluster_min_max_dis(0.3),
max_Leg_range(8),
...
keep_dist(1.0),
max_angular_vel(0.6),max_linear_vel(0.55),start_count(0),stop_count(0),count(0),openni_start(0),openni_stop(1),follow_finish(0),max_curve(1.4),min_curve(1.06)
  {  
    //获取参数
